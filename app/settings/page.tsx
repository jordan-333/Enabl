                      ...
                      <DialogHeader>
                        ...
                        <div className="grid gap-2">
                          ...
                          <Select onValueChange={(value) => {
                            // Reset KPI values when role changes
                            setFormData({})
                        ...
                        {/* KPI Settings based on role */}
                              {selectedRole === "setter" && (
                          <div className="space-y-4 border rounded-lg p-4">
                            <h3 className="font-medium">Setter KPI Targets</h3>
                            <div className="grid gap-4">
                              <div className="grid gap-2">
                                <Label htmlFor="setter-inputs">Total Inputs Weekly</Label>
                                      <Input 
                                  id="setter-inputs" 
                                        type="number" 
                                  placeholder="Enter target number"
                                  value={formData["setter-inputs"] || ""}
                                  onChange={(e) => handleKPIChange("setter-inputs", e.target.value)}
                                />
                                {formErrors["setter-inputs"] && (
                                  <p className="text-sm text-red-500">{formErrors["setter-inputs"]}</p>
                                      )}
                                    </div>
                              <div className="grid gap-2">
                                <Label htmlFor="setter-conversations">Positive Conversations Weekly</Label>
                                      <Input 
                                  id="setter-conversations" 
                                        type="number" 
                                  placeholder="Enter target number"
                                  value={formData["setter-conversations"] || ""}
                                  onChange={(e) => handleKPIChange("setter-conversations", e.target.value)}
                                      />
                                {formErrors["setter-conversations"] && (
                                  <p className="text-sm text-red-500">{formErrors["setter-conversations"]}</p>
                                      )}
                                    </div>
                              <div className="grid gap-2">
                                <Label htmlFor="setter-meetings">Calls Booked Weekly</Label>
                                      <Input 
                                  id="setter-meetings" 
                                        type="number" 
                                  placeholder="Enter target number"
                                  value={formData["setter-meetings"] || ""}
                                  onChange={(e) => handleKPIChange("setter-meetings", e.target.value)}
                                />
                                {formErrors["setter-meetings"] && (
                                  <p className="text-sm text-red-500">{formErrors["setter-meetings"]}</p>
                                      )}
                                    </div>
                                  </div>
                          </div>
                              ...
                              {selectedRole === "closer" && (
                          <div className="space-y-4 border rounded-lg p-4">
                            <h3 className="font-medium">Closer KPI Targets</h3>
                            <div className="grid gap-4">
                              <div className="grid gap-2">
                                <Label htmlFor="closer-calls">Calls Taken Weekly</Label>
                                      <Input 
                                  id="closer-calls" 
                                        type="number" 
                                  placeholder="Enter target number"
                                  value={formData["closer-calls"] || ""}
                                  onChange={(e) => handleKPIChange("closer-calls", e.target.value)}
                                />
                                {formErrors["closer-calls"] && (
                                  <p className="text-sm text-red-500">{formErrors["closer-calls"]}</p>
                                      )}
                                    </div>
                              <div className="grid gap-2">
                                <Label htmlFor="closer-deals">Deals Closed Weekly</Label>
                                      <Input 
                                  id="closer-deals" 
                                        type="number" 
                                  placeholder="Enter target number"
                                  value={formData["closer-deals"] || ""}
                                  onChange={(e) => handleKPIChange("closer-deals", e.target.value)}
                                />
                                {formErrors["closer-deals"] && (
                                  <p className="text-sm text-red-500">{formErrors["closer-deals"]}</p>
                                      )}
                                    </div>
                              <div className="grid gap-2">
                                <Label htmlFor="closer-revenue">Revenue Generated Monthly</Label>
                                      <Input 
                                  id="closer-revenue" 
                                        type="number" 
                                  placeholder="Enter target amount"
                                  value={formData["closer-revenue"] || ""}
                                  onChange={(e) => handleKPIChange("closer-revenue", e.target.value)}
                                />
                                {formErrors["closer-revenue"] && (
                                  <p className="text-sm text-red-500">{formErrors["closer-revenue"]}</p>
                                      )}
                                    </div>
                                  </div>
                                    </div>
